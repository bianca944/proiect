...
os.environ["GRPC_DEFAULT_AUTHORITY"] = "ipv4-only"
...
my_api_key = "AIzaSyD634UXgV9gHOrHgkUaJLGhZlEVIsVI7jI"
    ...
    while True:     
        ...
        with mic as source:            
            ...
            try: 
                ...
                if sleeping == True:
                    # User can start the conversation with the wake word "Jack"a 
